/*
 * $Id: ShipInfo.java 12 2006-03-25 16:19:37Z root $ Created on Mar 25, 2006 Copyright Paul Burlov
 * 2001-2006
 */
...
/**
 * Klasse zum Austauschen der Schiffsinformationen beim Kämpf
 * 
 * @author pb
 */
final public class ShipInfo
{
	...
	/**
	 * Konstruktor für deserialize(..) Methode
	 */
	protected ShipInfo()
	{
		super();
	...
	static public void serialize(mou.core.ship.Ship localShip, DataOutput out) throws IOException
	{
	...
	static public ShipInfo deserialize(DataInput in) throws IOException
	{
