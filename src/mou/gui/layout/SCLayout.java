/*
 * @(#)SCLayout.java 1.02 2 Jan 2002 Copyright John Redmond (John.Redmond@mq.edu.au). This software
...
public class SCLayout extends SGLayout
{
	...
	/**
	 * Creates a layout with the specified number of rows and default alignments and gaps.
	 * <p>
	 * vertical gaps are set to 0 and X- and Y-alignments are set to FILL.
	 * 
	 * @param rows
	 *            the rows.
	 */
	 ...
	 *            the cell number.
	 * @param hAlignment
	 *            the X-alignment for the cell.
	 * @param vAlignment
	 *            the Y-alignment for the cell.
	 */
