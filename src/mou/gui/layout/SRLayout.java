/*
 * @(#)SRLayout.java 1.02 2 Jan 2002 Copyright John Redmond (John.Redmond@mq.edu.au). This software
...
public class SRLayout extends SGLayout
{
	 ...
	 * <p>
	 * horizontal gaps are set to 0 and X- and Y-alignments are set to FILL.
	 * 
	 * @param cols
	 *            the columns.
	 */
